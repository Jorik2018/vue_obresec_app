<template>
	<ion-content :scroll-events="true">
		<v-form style="padding:10px;" class="v-form" :class="o.id<0||(o.tmpId&&!o.synchronized)?'yellow':(o.tmpId?'green':'')" store="poll" action="/api/poll">
			...
			SECCIÓN C: CARACTERÍSTICAS SOCIODEMOGRÁFICAS II (Responde solo el jefe de hogar)</h2>
			...
			<v-fieldset legend="31. SIN TENER EN CUENTA EL LUGAR DONDE NACIÓ, ¿DONDE HA VIVIDO USTED EN LOS ÚLTIMOS 5 AÑOS?">
			...
			<v-fieldset v-if="o.p_31&&o.p_31<3" legend="31. CUÁL FUE EL ÚLTIMO DISTRITO DÓNDE USTED VIVIÓ ANTES DE SU ACTUAL RESIDENCIA? (completar con código de ubigeo salvo en la alternativa 4 en la que se indica el país en caso de respuesta positiva a la alternativa 2 de la pregunta 28)">
	...
	data(){
		return{
			...
			regionList_2:[],provinceList_2:[],districtList_2:[],o:{
				...
				p_30_1:null,p_30_2:null,p_30_3:null,
				p_32_1:null,p_32_2:null,p_32_3:null,
				ext:{}}
		}
	},
	mounted(){
